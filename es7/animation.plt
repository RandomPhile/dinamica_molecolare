...
# n = 1
# step = 1
# splot "coordinate.xyz" every ::1::n+N-1 u 2:3:4 pt 7 ps 1 title sprintf('step = %03.0f    t = %f',step,(n-1)*dt/N),\
# 	  "coordinate.xyz" every ::1::n+N-1 u 2:3:4:1 w labels offset 2 title ""
